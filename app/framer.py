...
def run_framing_job():
    ...
    try:
        ...
        for c in to_process:
            ...
            logger.info(f"[framing] Cached 4 framings for cluster {cluster_id}: {title[:50]}")
